...
public class N_Queens {
    ...
    private static boolean isSafe(boolean[][] board, int row, int col) {
        ...
        int maxRight = Math.min(row, board.length - col - 1); // we are doing col-1 because index starts from 0 and we want to check the right side diagonal.
